...
function addSkillColors(event) {
    ...
    if (project.id === 'school') {
        for (skill of ['html5', 'css3', 'javascript', 'csharp', 'dotnet', 'bootstrap','sql']) {
            skillElement = document.getElementById(skill);
            skillElement.classList.add("selected");
        }
    }
    if (project.id === 'courier') {
        for (skill of ['html5', 'css3', 'javascript', 'csharp', 'dotnet', 'bootstrap','sql','azure']) {
            skillElement = document.getElementById(skill);
            skillElement.classList.add("selected");
        }
    }
